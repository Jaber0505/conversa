...
@Component({
  ...
  styleUrls: ['./searchbar-demo.component.scss'],
})
export class SearchbarDemoComponent  {
  ...
  // liste massive (performance + scroll)
  ...
  // States pour tests 2-way binding
  // Select single
  lang?: string = 'fr';
  area?: string;
  // MultiSelect (objet)
  ...
  // MultiSelect par value[] (si tu veux tester l’autre API)
  ...
  onSearch(payload: any)        { console.log('search', payload); }
